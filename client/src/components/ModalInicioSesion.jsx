  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="flex flex-col items-center mb-4">
        <img src="logoS.svg" alt="Sportify logo" className="w-37" />
      </div>
      ...
      <p className="text-white text-center mb-4">
        ...
        <button className="font-bold bg-transparent" onClick={closeModal}>
          Registrate
        </button>
      </p>
...
// Main RegistrationModal component
const RegistrationModal = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <button onClick={openModal} className="bg-blue-600 text-white p-3 rounded-md">
        Iniciar Sesión
      </button>
